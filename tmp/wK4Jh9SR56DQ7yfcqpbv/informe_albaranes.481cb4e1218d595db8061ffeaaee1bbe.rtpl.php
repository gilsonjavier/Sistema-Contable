            ...
            <div class="col-sm-12">
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-title"><span class="text-capitalize"><?php  echo FS_ALBARANES;?></span> últimos 30 días</h3>
                  </div>
                  <div class="panel-body">
                     <canvas id="chart_albaranes_mes_actual" style="height: 350px;"></canvas>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <?php $loop_var1=$fsc->stats_estados('albaranesprov'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <?php $loop_var1=$fsc->stats_almacenes('albaranesprov'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <?php $loop_var1=$fsc->stats_series('albaranesprov'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <?php $loop_var1=$fsc->stats_formas_pago('albaranesprov'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="table-responsive">
                     <table class="table table-hover">
                        ...
                        <?php $loop_var1=$fsc->stats_agentes('albaranesprov'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
...
<script type="text/javascript">
   $(document).ready(function () {
      ...
      /// cargamos los datos de los albaranes del mes actual
      var albaranes_mes_actual_labels = [];
      var albaranes_mes_actual_data = [
         [],[]
      ];
      
      <?php $loop_var1=$fsc->stats_last_30_days(); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>

      albaranes_mes_actual_labels.push("<?php echo $value1['day'];?>");
      albaranes_mes_actual_data[0].push("<?php echo $value1['total_pro'];?>");
      albaranes_mes_actual_data[1].push("<?php echo $value1['total_cli'];?>");
      <?php } ?>

      
      /// esto es un apaño para evitar los problemas de charts.js con tabs en bootstrap
      var ctx1 = document.getElementById('chart_albaranes_mes_actual').getContext('2d');
      ctx1.canvas.height = 150;
      
      var chart1 = new Chart(ctx1, {
            type: 'bar',
            data: {
               labels: albaranes_mes_actual_labels,
               datasets: [
                  {
                     label: 'compras',
                     backgroundColor: "rgba(255, 99, 132,0.8)",
                     data: albaranes_mes_actual_data[0]
                  },
                  {
                     label: 'ventas',
                     backgroundColor: "rgba(54, 162, 235,0.8)",
                     data: albaranes_mes_actual_data[1]
                  }
               ]
            }
         }
      ...
      /// cargamos los datos de los albaranes por mes
      ...
      <!--<?php $data=$this->var['data']=$fsc->stats_series('albaranesprov');?>-->
      ...
      <!--<?php $data=$this->var['data']=$fsc->stats_almacenes('albaranesprov');?>-->
      ...
      <!--<?php $data=$this->var['data']=$fsc->stats_formas_pago('albaranesprov');?>-->
      ...
      <!--<?php $data=$this->var['data']=$fsc->stats_estados('albaranesprov');?>-->
      ...
      <!--<?php $data=$this->var['data']=$fsc->stats_agentes('albaranesprov');?>-->
