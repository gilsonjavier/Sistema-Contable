...
<div class="table-responsive">
   <table class="table table-hover">
      ...
      <tr>
         <td><a href="<?php echo $value1->url();?>" target="_parent"><?php echo $value1->codigo;?></a> <?php echo $value1->numproveedor;?></td>
               ...
               <div class="panel-body">
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           Núm. Proveedor:
                           <input type="text" name="numproveedor" value="" class="form-control" autocomplete="off"/>
                        </div>
                     </div>
